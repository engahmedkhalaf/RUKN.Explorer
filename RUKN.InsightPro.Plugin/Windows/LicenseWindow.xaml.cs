...
namespace RUKN.InsightPro.Plugin.Windows
{
    public partial class LicenseWindow : Window
    {
        ...
        private async void BtnActivate_Click(object sender, RoutedEventArgs e)
        {
            ...
            var result = await RUKN.InsightPro.Plugin.Utils.SupabaseService.ActivateLicenseAsync(enteredKey, email, machineName);
        ...
        private async void BtnDeactivate_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == MessageBoxResult.Yes)
            {
                ...
                {
                    await RUKN.InsightPro.Plugin.Utils.SupabaseService.DeactivateLicenseAsync(key, System.Environment.MachineName);
                }
